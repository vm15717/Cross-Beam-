...
def TorsMerging():
    ...
    #mdb.models['Model-1'].steps['Step-1'].setValues(maxNumInc=10000,initialInc=0.001, minInc=2e-16, 
    ...
    for i in range(1,len(n)+1):      
        ...
        mdb.models['Model-1'].ConcentratedForce(name='Load-'+str(i), createStepName='Step-2', 
